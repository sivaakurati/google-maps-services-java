...
/**
 * Performs a text search for places. The Google Places API enables you to get
 * data from the same database used by Google Maps and Google+ Local. Places
 * features more than 100 million businesses and points of interest that are
 * updated frequently through owner-verified listings and user-moderated
 * contributions.
 *
 * <p>
 * See also: <a href="https://developers.google.com/places/web-service/">Places
 * API Web Service documentation</a>.
 */
public class PlacesApi {
	 ...
	 *
	 * @param context
	 *            The context on which to make Geo API requests.
	 * @param location
	...
	/**
	 * Retrieves the next page of Nearby Search results. The nextPageToken, returned
	 * in a PlacesSearchResponse when there are more pages of results, encodes all
	 * of the original Nearby Search Request parameters, which are thus not required
	 * on this call.
	 *
	 * @param context
	 *            The context on which to make Geo API requests.
	 * @param nextPageToken
	 *            The nextPageToken returned as part of a PlacesSearchResponse.
	...
	/**
	 * Performs a search for Places using a text query; for example, "pizza in New
	 * York" or "shoe stores near Ottawa".
	 *
	 * @param context
	 *            The context on which to make Geo API requests.
	 * @param query
	...
	/**
	 * Retrieves the next page of Text Search results. The nextPageToken, returned
	 * in a PlacesSearchResponse when there are more pages of results, encodes all
	 * of the original Text Search Request parameters, which are thus not required
	 * on this call.
	 *
	 * @param context
	 *            The context on which to make Geo API requests.
	 ...
	 *
	 * <p>
	 * We are only enabling looking up Places by placeId as the older Place
	 * identifier, reference, is deprecated. Please see the <a href=
	 * "https://web.archive.org/web/20170521070241/https://developers.google.com/places/web-service/details#deprecation">
	 * deprecation warning</a>.
	 *
	 * @param context
	 *            The context on which to make Geo API requests.
	 * @param placeId
	 *            The PlaceID to request details on.
	 ...
	 *
	 * <p>
	 * Note: If you want to use a Photo in a web browser, please retrieve the photos
	 * for a place via our <a href=
	 * "https://developers.google.com/maps/documentation/javascript/places#places_photos">
	 * JavaScript Places Library</a>. Likewise, on Android, Places Photos can be
	 * retrieved using the
	 * <a href="https://developers.google.com/places/android-api/photos">Google
	 * Places API for Android</a>.
	 *
	 * @param context
	 *            The context on which to make Geo API requests.
	...
	/**
	 * Creates a new Places Autocomplete request for a given input. The Place
	 * Autocomplete service can match on full words as well as substrings.
	 ...
	 * @param sessionToken
	 *            Session token, to make sure requests are billed per session,
	 *            instead of per character.
	 * @return Returns a PlaceAutocompleteRequest that you can configure and
	 *         execute.
	 */
	...
	/**
	 * Allows you to add on-the-fly geographic query predictions to your
	 * application.
	 *
	 * @param context
	 *            The context on which to make Geo API requests.
	 * @param input
	 *            input is the text string on which to search.
	 * @return Returns a QueryAutocompleteRequest that you can configure and
	 *         execute.
	 */
	 ...
	 *            The context on which to make Geo API requests.
	 * @param input
	 *            The input to search on.
	 * @param inputType
	 *            Whether the input is search text, or a phone number.
	 * @return Returns a FindPlaceFromTextRequest that you can configure and
	 *         execute.
	 */
	public static FindPlaceFromTextRequest findPlaceFromText(GeoApiContext context, String input,
