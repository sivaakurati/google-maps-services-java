...
public class DirectionsApiRequest
	 ...
	 * calculate directions. If you pass an address as a location, the Directions
	 * service will geocode the location and convert it to a latitude/longitude
	 * coordinate to calculate directions. If you pass coordinates, ensure that no
	 * space exists between the latitude and longitude values.
	 *
	 * @param origin
	 *            The starting location for the Directions request.
	 ...
	 *
	 * @param destination
	 *            The ending location for the Directions request.
	 * @return Returns this {@code DirectionsApiRequest} for call chaining.
	 */
	...
	/**
	 * Specifies the mode of transport to use when calculating directions. The mode
	 * defaults to driving if left unspecified. If you set the mode to
	 * {@code TRANSIT} you must also specify either a {@code departureTime} or an
	 * {@code arrivalTime}.
	 *
	 * @param mode
	 ...
	 *
	 * @param restrictions
	 *            one or more of {@link DirectionsApi.RouteRestriction#TOLLS},
	 *            {@link DirectionsApi.RouteRestriction#HIGHWAYS},
	 *            {@link DirectionsApi.RouteRestriction#FERRIES}
	 * @return Returns this {@code DirectionsApiRequest} for call chaining.
	 */
	 ...
	 *
	 * @param units
	 *            The preferred units for displaying distances.
	 * @return Returns this {@code DirectionsApiRequest} for call chaining.
	 */
	 ...
	 *
	 * @param time
	 *            The arrival time to calculate directions for.
	 * @return Returns this {@code DirectionsApiRequest} for call chaining.
	 */
	...
	/**
	 * Set the departure time for a transit or driving directions request. If both
	 * departure time and traffic model are not provided, then "now" is assumed. If
	 * traffic model is supplied, then departure time must be specified.
	 *
	 * @param time
	 *            The departure time to calculate directions for.
	 * @return Returns this {@code DirectionsApiRequest} for call chaining.
	 */
	...
	/**
	 * Specifies a list of waypoints. Waypoints alter a route by routing it through
	 * the specified * location(s). A waypoint is specified as either a
	 * latitude/longitude coordinate or as an address * which will be geocoded.
	 * Waypoints are only supported for driving, walking and bicycling * directions.
	 *
	 * <p>
	 * For more information on waypoints, see <a href=
	 * "https://developers.google.com/maps/documentation/directions/intro#Waypoints">Using
	 * Waypoints in Routes</a>.
	 *
	 * @param waypoints
	 *            The waypoints to add to this directions request.
	 * @return Returns this {@code DirectionsApiRequest} for call chaining.
	 */
	 ...
	 * the waypoints in a more efficient order.
	 *
	 * @param optimize
	 *            Whether to optimize waypoints.
	 * @return Returns this {@code DirectionsApiRequest} for call chaining.
	 */
	...
	/**
	 * If set to true, specifies that the Directions service may provide more than
	 * one route alternative in the response. Note that providing route alternatives
	 * may increase the response time from the server.
	 *
	 * @param alternateRoutes
	 *            whether to return alternate routes.
	 * @return Returns this {@code DirectionsApiRequest} for call chaining.
	 */
	 ...
	 *
	 * @param pref
	 *            The transit routing preferences for this request.
	 * @return Returns this {@code DirectionsApiRequest} for call chaining.
	 */
	 ...
	 *
	 * @param trafficModel
	 *            The traffic model for estimating driving time.
	 * @return Returns this {@code DirectionsApiRequest} for call chaining.
	 */
	...
	public static class Waypoint {
		 ...
		 *
		 * @param location
		 *            Any address or location recognized by the Google Maps API.
		 */
		 ...
		 *
		 * @param location
		 *            The LatLng coordinates of this waypoint.
		 */
		...
		/**
		 * Gets the String representation of this Waypoint, as an API request parameter
		 * fragment.
		 *
