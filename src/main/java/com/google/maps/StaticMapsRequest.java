...
public class StaticMapsRequest extends PendingResultBase<ImageResult, StaticMapsRequest, ImageResult.Response> {
	...
	/**
	 * <code>center</code> (required if markers not present) defines the center of
	 * the map, equidistant from all edges of the map.
	 *
	 * @param location
	...
	/**
	 * <code>zoom</code> (required if markers not present) defines the zoom level of
	 * the map, which determines the magnification level of the map.
	 *
	 * @param zoom
	 *            The zoom level of the region.
	 * @return Returns this {@code StaticMapsRequest} for call chaining.
	 */
	...
	/**
	 * <code>scale</code> affects the number of pixels that are returned. Setting
	 * <code>scale</code> to 2 returns twice as many pixels as <code>scale</code>
	 * set to 1 while retaining the same coverage area and level of detail (i.e. the
	 * contents of the map doesn't change).
	 *
	 * @param scale
	 *            The scale of the static map.
	 * @return Returns this {@code StaticMapsRequest} for call chaining.
	 */
	...
	public enum ImageFormat implements UrlValue {
		png("png"), png8("png8"), png32("png32"), gif("gif"), jpg("jpg"), jpgBaseline("jpg-baseline");
	...
	/**
	 * <code>format</code> defines the format of the resulting image. By default,
	 * the Google Static Maps API creates PNG images. There are several possible
	 * formats including GIF, JPEG and PNG types.
	 *
	 * @param format
	 *            The format of the static map.
	 * @return Returns this {@code StaticMapsRequest} for call chaining.
	 */
	 ...
	 *
	 * @param maptype
	 *            The map type of the static map.
	 * @return Returns this {@code StaticMapsRequest} for call chaining.
	 */
	...
	public static class Markers implements UrlValue {
		...
		/**
		 * Specifies the size of marker. If no size parameter is set, the marker will
		 * appear in its default (normal) size.
		 *
		 * @param size
		...
		/**
		 * Specifies a 24-bit color (example: color=0xFFFFCC) or a predefined color from
		 * the set {black, brown, green, purple, yellow, blue, gray, orange, red,
		 * white}.
		 *
		 * @param color
		 ...
		 *
		 * @param url
		 *            URL for the custom icon.
		 * @param anchorPoint
		 *            The anchor point for this custom icon.
		 */
		 ...
		 *            The anchor point for this custom icon.
		 * @param scale
		 *            Set the image density scale (1, 2, or 4) of the custom icon
		 *            provided.
		 */
		 ...
		 *
		 * @param location
		 *            The location of the added marker.
		 */
	...
	/**
	 * <code>markers</code> parameter defines a set of one or more markers (map
	 * pins) at a set of locations. Each marker defined within a single markers
	 * declaration must exhibit the same visual style; if you wish to display
	 * markers with different styles, you will need to supply multiple markers
	 * parameters with separate style information.
	 *
	 * @param markers
	 *            A group of markers with the same style.
	 * @return Returns this {@code StaticMapsRequest} for call chaining.
	 */
	...
	public static class Path implements UrlValue {
		...
		/**
		 * Specifies the thickness of the path in pixels. If no weight parameter is set,
		 * the path will appear in its default thickness (5 pixels).
		 *
		 * @param weight
		 ...
		 * that follows the curvature of the earth.
		 *
		 * @param geodesic
		 *            Whether the path is geodesic.
		 */
	...
	/**
	 * The <code>path</code> parameter defines a set of one or more locations
	 * connected by a path to overlay on the map image.
	 *
	 * @param path
	 *            A path to render atop the map.
	 * @return Returns this {@code StaticMapsRequest} for call chaining.
	 */
	...
	/**
	 * <code>visible</code> instructs the Google Static Maps API service to
	 * construct a map such that the existing locations remain visible.
	 *
	 * @param visibleLocation
	 *            The location to be made visible in the requested Static Map.
	 * @return Returns this {@code StaticMapsRequest} for call chaining.
	 */
