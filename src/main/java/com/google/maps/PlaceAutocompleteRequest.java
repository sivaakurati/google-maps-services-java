 ...
 */
public class PlaceAutocompleteRequest extends
		PendingResultBase<AutocompletePrediction[], PlaceAutocompleteRequest, PlaceAutocompleteRequest.Response> {
	...
	public static final class SessionToken implements UrlValue {
		...
		/**
		 * Retrieve the universally unique identifier for this session. This enables you
		 * to recreate the session token in a later context.
		 *
	...
	/**
	 * Sets the SessionToken for this request. Using session token makes sure the
	 * autocomplete is priced per session, instead of per keystroke.
	 *
	 * @param sessionToken
	 *            Session Token is the session identifier.
	...
	/**
	 * Sets the text string on which to search. The Places service will return
	 * candidate matches based on this string and order results based on their
	 * perceived relevance.
	 *
	 * @param input
	 *            The input text to autocomplete.
	 * @return Returns this {@code PlaceAutocompleteRequest} for call chaining.
	 */
	 ...
	 * predictions. For example, if the input is 'Googl' and the completion point is
	 * 3, the service will match on 'Goo'. The offset should generally be set to the
	 * position of the text caret. If no offset is supplied, the service will use
	 * the entire term.
	 *
	 * @param offset
	 *            The character offset position of the user's cursor.
	 * @return Returns this {@code PlaceAutocompleteRequest} for call chaining.
	 */
	 ...
	 *
	 * @param location
	 *            The {@link LatLng} location to center this autocomplete search.
	 * @return Returns this {@code PlaceAutocompleteRequest} for call chaining.
	 */
	 ...
	 *
	 * @param radius
	 *            The radius over which to bias results.
	 * @return Returns this {@code PlaceAutocompleteRequest} for call chaining.
	 */
	 ...
	 *
	 * @param type
	 *            The type to restrict results to.
	 * @return Returns this {@code PlaceAutocompleteRequest} for call chaining.
	 ...
	 *
	 * @param filters
	 *            The component filter to restrict results with.
	 * @return Returns this {@code PlaceAutocompleteRequest} for call chaining.
	 */
	...
	/**
	 * StrictBounds returns only those places that are strictly within the region
	 * defined by location and radius. This is a restriction, rather than a bias,
	 * meaning that results outside this region will not be returned even if they
	 * match the user input.
	 *
	 * @param strictBounds
	 *            Whether to strictly bound results.
	 * @return Returns this {@code PlaceAutocompleteRequest} for call chaining.
	 */
