...
public class GeocodingResult implements Serializable {
	 ...
	 * address components. For example, the address "111 8th Avenue, New York, NY"
	 * contains separate address components for "111" (the street number, "8th
	 * Avenue" (the route), "New York" (the city) and "NY" (the US state). These
	 * address components contain additional information.
	 */
	public String formattedAddress;

	/**
	 * All the localities contained in a postal code. This is only present when the
	 * result is a postal code that contains multiple localities.
	 */
	...
	/**
	 * The types of the returned result. This array contains a set of zero or more
	 * tags identifying the type of feature returned in the result. For example, a
	 ...
	 * misspelled address component, the geocoding service may suggest an alternate
	 * address. Suggestions triggered in this way will not be marked as a partial
	 * match.
	 */
