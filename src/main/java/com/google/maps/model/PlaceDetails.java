...
public class PlaceDetails implements Serializable {
	...
	public static class AlternatePlaceIds implements Serializable {
		 ...
		 * alternative place ID is if your application adds a place and receives an
		 * application-scoped place ID, then later receives a Google-scoped place ID
	 ...
	 * related to each alternative ID.
	 */
	...
	public static class Review implements Serializable {
		 ...
		 * attribute of the establishment.
		 *
		 * <p>
		 * Note: this is a <a href=
		 * "https://developers.google.com/places/web-service/details#PremiumData">Premium
		 * Data</a> field available to the Google Places API for Work customers.
		 */
	 ...
	 * Place Details request, the Places Service will bias the results to prefer
	 ...
	 * establishment's Google+ page if the Google+ page exists, otherwise it will be
	 * the Google-owned page that contains the best available information about the
	 * place. Applications must link to or embed this page on any screen that shows
