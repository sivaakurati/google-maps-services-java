...
public class TransitLine implements Serializable {
	 ...
	 * such as {@code "M7"} or {@code "355"}.
	 */
	public String shortName;

	/**
	 * The color commonly used in signage for this transit line. The color will be
	 * specified as a hex string, such as {@code "#FF0033"}.
	 */
	public String color;
	...
	/**
	 * The color of text commonly used for signage of this transit line. The color
	 * will be specified as a hex string, such as {@code "#FF0033"}.
	 */
