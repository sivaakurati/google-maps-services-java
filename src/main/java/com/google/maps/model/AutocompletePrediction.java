...
/**
 * Represents a single Autocomplete result returned from the Google Places API
 * Web Service.
 *
 * <p>
 * Please see <a href=
 * "https://developers.google.com/places/web-service/query#query_autocomplete_responses">Query
...
public class AutocompletePrediction implements Serializable {
	 ...
	 * <p>
	 * Please see
	 * <a href="https://developers.google.com/places/supported_types">supported
	 ...
	 * section of the description is generally terminated with a comma.) Each entry
	 * in the array has a value field, containing the text of the term, and an
	 * offset field, defining the start position of this term in the description,
	...
	/**
	 * The locations of the entered term in the prediction result text, so that the
	...
	/**
	 * Identifies each section of the returned description. (A section of the
	 * description is generally terminated with a comma.)
	 */
	public static class Term {

		/**
		 * The start position of this term in the description, measured in Unicode
		 * characters.
		 */
		public int offset;
	...
	public String toString() {
		return String.format(
				...
				description, placeId, Arrays.toString(types), Arrays.toString(terms),
				Arrays.toString(matchedSubstrings), Objects.toString(structuredFormatting));
	}
}
