...
public class RateLimitExecutorService implements ExecutorService, Runnable {
	...
	// the threads are
	// killed when the app exits. For synchronous requests this is ideal but it
	// means any async
	// requests still pending after termination will be killed.
	private final ExecutorService delegate = new ThreadPoolExecutor(Runtime.getRuntime().availableProcessors(),
