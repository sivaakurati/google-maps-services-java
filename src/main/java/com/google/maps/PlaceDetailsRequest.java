...
/**
 * A <a href=
 * "https://developers.google.com/places/web-service/details#PlaceDetailsRequests">Place
 * Details</a> request.
 */
public class PlaceDetailsRequest
	...
	/**
	 * Sets the SessionToken for this request. Use this for Place Details requests
	 * that are called following an autocomplete request in the same user session.
	 * Optional.
	 *
	 * @param sessionToken
	...
	/**
	 * Sets the Region for this request. The region code, specified as a ccTLD
	 * (country code top-level domain) two-character value. Most ccTLD codes are
	 * identical to ISO 3166-1 codes, with some exceptions. This parameter will only
	 * influence, not fully restrict, results.
	 *
	 * @param region
	 *            The region code.
	 * @return Returns this {@code PlaceDetailsRequest} for call chaining.
	 ...
	 *
	 * @param fields
	 *            The Field Masks of the fields to return.
	 * @return Returns this {@code PlaceDetailsRequest} for call chaining.
	 */
	...
	public enum FieldMask implements UrlValue {
		ADDRESS_COMPONENT("address_component"), ADR_ADDRESS("adr_address"), ALT_ID("alt_id"), FORMATTED_ADDRESS(
				"formatted_address"), FORMATTED_PHONE_NUMBER("formatted_phone_number"), GEOMETRY("geometry"), ICON(
						"icon"), ID("id"), INTERNATIONAL_PHONE_NUMBER("international_phone_number"), NAME(
								"name"), OPENING_HOURS("opening_hours"), PERMANENTLY_CLOSED(
										"permanently_closed"), PHOTOS("photos"), PLACE_ID("place_id"), PRICE_LEVEL(
												"price_level"), RATING("rating"), REFERENCE("reference"), REVIEWS(
														"reviews"), SCOPE("scope"), TYPES("types"), URL(
																"url"), UTC_OFFSET("utc_offset"), VICINITY(
