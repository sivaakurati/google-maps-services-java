...
public class OkHttpRequestHandler implements GeoApiContext.RequestHandler {
	...
	public <T, R extends ApiResponse<T>> PendingResult<T> handle(String hostName, String url, String userAgent,
		...
		return new OkHttpPendingResult<>(req, client, clazz, fieldNamingPolicy, errorTimeout, maxRetries,
	...
	public static class Builder implements GeoApiContext.RequestHandler.Builder {
		...
		/**
		 * Gets a reference to the OkHttpClient.Builder used to build the
		 * OkHttpRequestHandler's internal OkHttpClient. This allows you to fully
		 * customize the OkHttpClient that the resulting OkHttpRequestHandler will make
